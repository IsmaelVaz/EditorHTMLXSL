...
uses
  ...
  StdCtrls, ExtCtrls, ufrmDialogSearchText;

type
  TfrmDialogReplace = class(TfrmDialogTextSearch)
    Label2: TLabel;
...
function TfrmDialogReplace.GetReplaceText: string;
begin
  Result := cbReplaceText.Text;
end;

function TfrmDialogReplace.GetReplaceTextHistory: string;
var
  i: integer;
begin
  Result := '';
...
procedure TfrmDialogReplace.SetReplaceText(Value: string);
begin
  cbReplaceText.Text := Value;
end;

procedure TfrmDialogReplace.SetReplaceTextHistory(Value: string);
begin
  cbReplaceText.Items.Text := Value;
end;

procedure TfrmDialogReplace.FormCloseQuery(Sender: TObject;
