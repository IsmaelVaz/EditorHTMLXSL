...
type
  TfrmDialogConfirmReplace = class(TForm)
    btnReplace: TButton;
...
var
  frmDialogConfirmReplace: TfrmDialogConfirmReplace;
...
procedure TfrmDialogConfirmReplace.FormCreate(Sender: TObject);
begin
  Image1.Picture.Icon.Handle := LoadIcon(0, IDI_QUESTION);
end;

procedure TfrmDialogConfirmReplace.FormDestroy(Sender: TObject);
begin
  frmDialogConfirmReplace := nil;
end;

procedure TfrmDialogConfirmReplace.PrepareShow(AEditorRect: TRect;
