      ...
      if openDialogXML.Execute = True then begin
         ...
         try
            try
               ...
               //Por conta de um bug do Delphi 2010, não é possível configurar o xml corretamente
               //em iso-8859-1, portanto, é preciso fazer a alterar abaixo.
               FXMLLoaded.XML.Text:=stringreplace(FXMLLoaded.XML.Text, 'UTF-16','iso-8859-1',[rfReplaceAll, rfIgnoreCase]);
